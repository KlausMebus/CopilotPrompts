...
6. **Document the refined idea in a structured format**
    ...
    - Save the idea refinement document in markdown format in a file `idea-xxxx.md` (where `xxxx` is a unique incremental version starting from 0001) in the `docs` folder.
