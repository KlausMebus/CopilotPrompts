...
To guide an AI assistant in creating a detailed, step-by-step task list in Markdown format based on an existing Product Requirements Document (PRD) and an optional architecture document. The task list should guide a developer through implementation.

## Output

- **Format:** Markdown (`.md`)
- **Location:** `/tasks/`
- **Filename:** `tasks-xxxx.md` (where `xxxx` matches the base name of the input PRD file, e.g., `tasks-prd-user-profile-editing.md` or `tasks-prd-0001.md`)

## Process

1.  **Receive PRD Reference:** The user points the AI to a specific PRD file - or a general PRD is found in the `/docs` folder.
2.  **Analyze PRD:** The AI reads and analyzes the functional requirements, user stories, and other sections of the specified PRD.
3.  **Analyze Architecture:** The AI reads and analyzes the architecture document found in the `/docs` folder.
...
10.  **Save Task List:** Save the generated document in the specified location with the correct filename.
